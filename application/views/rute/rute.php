            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                      <a class="btn btn-warning btn-sm" href="<?php echo base_url(); ?>beranda/editrute/<?php echo  $u->id; ?>">Edit</a>
                      <a onclick="return confirm('Hapus data??');" class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>beranda/hapususer/<?php echo  $u->id;?>">Hapus</a>
                  </td>
                </tr>
                <?php } ?>
                </tbody>
