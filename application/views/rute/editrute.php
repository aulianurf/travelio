      ...
      <form action="<?php echo base_url()?>beranda/saveeditrute" method="post">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="hidden" id="id" class="form-control" value="<?php echo $id;?>" name="id">
                <input type="text" id="depart_at" class="form-control" value="<?php echo $depart_at;?>" name="depart_at" required>
              </div>
              <div class="form-group">
                <label>Arrival_at</label>
                <input type="password" id="arrival_at" class="form-control" value="<?php echo $arrival_at;?>" name="arrival_at" required>
              </div>
              <div class="form-group">
                <label>Rute_from</label>
                <input type="text" id="rute_from" class="form-control" value="<?php echo $rute_from;?>" name="rute_from" required>
              </div>
               <div class="form-group">
                <label>Rute_to</label>
               ...
               <div class="form-group">
                ...
                <input type="text" id="transportation_id" class="form-control" value="<?php echo $transportation_id;?>" name="transportation_id" required>
              </div>
              <div class="form-group">
