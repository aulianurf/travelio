...
<title>Wanderer a Travel Category Flat Bootstrap Responsive Website Template | Home :: W3layouts</title>
...
<!-- Bootstrap-Core-CSS --> 	<link rel="stylesheet"	href="<?php echo URL_ASSETS;?>css/bootstrap.min.css" 	type="text/css" media="all">
<!-- Index-Page-CSS --> 	<link rel="stylesheet"	href="<?php echo URL_ASSETS;?>css/style.css" 		type="text/css" media="all">
<!-- Flexslider-CSS --> 	<link rel="stylesheet" 	href="<?php echo URL_ASSETS;?>css/flexslider.css" 	type="text/css" media="all">
<!-- Popup-Box-CSS --> 		<link rel="stylesheet" 	href="<?php echo URL_ASSETS;?>css/chocolat.css" 		type="text/css" media="all">
<!-- //Custom-Stylesheet-Links -->
...
<body>
	...
	<div class="header" id="home">
		...
		<nav class="navbar navbar-default">
			<div class="container-fluid">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="index.html">TRAVELIO</a>
				</div>
		...
		<div class="slider">
			<ul class="rslides" id="slider1">
				<li>
					<img src="<?php echo URL_ASSETS;?>images/slide-1.jpg" alt="Wanderer">
					<div class="caption">
						<h3>INTERNATIONAL FLIGHT SERVICES</h3>
					</div>
				</li>
				<li>
					<img src="<?php echo URL_ASSETS;?>images/slide-2.jpg" alt="Wanderer">
					<div class="caption">
						<h3>Feel the love of the nature</h3>
					</div>
				</li>
				<li>
					<img src="<?php echo URL_ASSETS;?>images/slide-3.jpg" alt="Wanderer">
					<div class="caption">
						<h3>Away from the concrete jungles</h3>
					</div>
				</li>
				<li>
					<img src="<?php echo URL_ASSETS;?>images/slide-4.jpg" alt="Wanderer">
					<div class="caption">
						<h3>Achieve nirvana and inner peace</h3>
					</div>
				</li>
				<li>
					<img src="<?php echo URL_ASSETS;?>images/slide-5.jpg" alt="Wanderer">
					<div class="caption">
	...
	<div class="about" id="about">
		<div class="container">
			...
			<h1>LOG IN</h1>
			<p class="para">Travelio merupakan sarana </p>
			...
			<div class="agency-grids">
				<div class="col-md-3 col-sm-3 agency-grid">
					<div class="agency-grid-img">
						<img src="<?php echo URL_ASSETS;?>images/agency-1.png" alt="Wanderer">
					</div>
					<h4>World Tour</h4>
				...
				<div class="col-md-3 col-sm-3 agency-grid">
					<div class="agency-grid-img">
						<img src="<?php echo URL_ASSETS;?>images/agency-2.png" alt="Wanderer">
					</div>
				...
				<div class="col-md-3 col-sm-3 agency-grid">
					<div class="agency-grid-img">
						<img src="<?php echo URL_ASSETS;?>images/agency-3.png" alt="Wanderer">
					</div>
				...
				<div class="col-md-3 col-sm-3 agency-grid">
					<div class="agency-grid-img">
						<img src="<?php echo URL_ASSETS;?>images/agency-4.png" alt="Wanderer">
					</div>
					<h4>Beach Resorts</h4>
					<p>Sed ut perspiciatis unde omnis iste natus duis error sit voluptatem accusantium ile doloremque.</p>
				</div>
					...
					<div id="myTabContent" class="tab-content">
						<div role="tabpanel" class="tab-pane fade in active" id="expeditions" aria-labelledby="expeditions-tab">
							<div class="col-md-5 col-sm-5 tab-image">
								<img src="<?php echo URL_ASSETS;?>images/tab-1.jpg" alt="Wanderer">
							</div>
						...
						<div role="tabpanel" class="tab-pane fade" id="tours" aria-labelledby="tours-tab">
							<div class="col-md-5 col-sm-5 tab-image">
								<img src="<?php echo URL_ASSETS;?>images/tab-2.jpg" alt="Wanderer">
							</div>
							<div class="col-md-7 col-sm-7 tab-info">
						...
						<div role="tabpanel" class="tab-pane fade" id="tree" aria-labelledby="tree-tab">
							<div class="col-md-5 col-sm-5 tab-image">
								<img src="<?php echo URL_ASSETS;?>images/tab-3.jpg" alt="Wanderer">
							</div>
							<div class="col-md-7 col-sm-7 tab-info">
						...
						<div role="tabpanel" class="tab-pane fade" id="safari" aria-labelledby="safari-tab">
							<div class="col-md-5 col-sm-5 tab-image">
								<img src="<?php echo URL_ASSETS;?>images/tab-4.jpg" alt="Wanderer">
							</div>
							<div class="col-md-7 col-sm-7 tab-info">
						...
						<div role="tabpanel" class="tab-pane fade" id="trekking" aria-labelledby="trekking-tab">
							<div class="col-md-5 col-sm-5 tab-image">
								<img src="<?php echo URL_ASSETS;?>images/tab-5.jpg" alt="Wanderer">
							</div>
							<div class="col-md-7 col-sm-7 tab-info">
						...
						<a class="example-image-link" href="images/gallery-1-big.jpg" data-lightbox="example-set" data-title="">
							<div class="grid">
								<figure class="effect-apollo">
									<img src="<?php echo URL_ASSETS;?>images/gallery-1.jpg" alt="Wanderer"/>
						...
						<div class="col-md-6 col-sm-6 gallery-grids-left-subl">
							<div class="gallery-grid">
								<a class="example-image-link" href="images/gallery-4-big.jpg" data-lightbox="example-set" data-title="">
									<div class="grid">
										<figure class="effect-apollo">
											<img src="<?php echo URL_ASSETS;?>images/gallery-4.jpg" alt="Wanderer"/>
												<figcaption></figcaption>
										</figure>
									</div>
								</a>
							...
							<div class="gallery-grid gallery-grid-sub grid-middle">
								<a class="example-image-link" href="images/gallery-5-big.jpg" data-lightbox="example-set" data-title="">
									<div class="grid">
										<figure class="effect-apollo">
											<img src="<?php echo URL_ASSETS;?>images/gallery-5.jpg" alt="Wanderer"/>
												<figcaption></figcaption>
										</figure>
									</div>
								</a>
						...
						<div class="col-md-6 col-sm-6 gallery-grids-left-subr">
							<div class="gallery-grid">
								<a class="example-image-link" href="images/gallery-7-big.jpg" data-lightbox="example-set" data-title="">
									<div class="grid">
										<figure class="effect-apollo">
											<img src="<?php echo URL_ASSETS;?>images/gallery-7.jpg" alt="Wanderer"/>
												<figcaption></figcaption>
										</figure>
									</div>
								</a>
					...
					<div class="col-md-6 col-sm-6 gallery-grids-right">
						<div class="gallery-grid">
							<a class="example-image-link" href="images/gallery-2-big.jpg" data-lightbox="example-set" data-title="">
								<div class="grid">
									<figure class="effect-apollo">
										<img src="<?php echo URL_ASSETS;?>images/gallery-2.jpg" alt="Wanderer"/>
											<figcaption></figcaption>
									</figure>
								</div>
							</a>
					...
					<div class="col-md-6 col-sm-6 gallery-grids-right two">
						<div class="gallery-grid">
							<a class="example-image-link" href="images/gallery-3-big.jpg" data-lightbox="example-set" data-title="">
								<div class="grid">
									<figure class="effect-apollo">
										<img src="<?php echo URL_ASSETS;?>images/gallery-3.jpg" alt="Wanderer"/>
											<figcaption></figcaption>
									</figure>
								</div>
							</a>
					...
					<div class="gallery-grids-right1">
						<div class="gallery-grid">
							<a class="example-image-link" href="images/gallery-6-big.jpg" data-lightbox="example-set" data-title="">
								<div class="grid">
									<figure class="effect-apollo">
										<img src="<?php echo URL_ASSETS;?>images/gallery-6.jpg" alt="Wanderer"/>
											<figcaption></figcaption>
									</figure>
								</div>
							</a>
					...
					<div class="col-md-6 col-sm-6 gallery-grids-right gallery-8">
						<div class="gallery-grid">
							<a class="example-image-link" href="images/gallery-8-big.jpg" data-lightbox="example-set" data-title="">
								<div class="grid">
									<figure class="effect-apollo">
										<img src="<?php echo URL_ASSETS;?>images/gallery-8.jpg" alt="Wanderer"/>
											<figcaption></figcaption>
									</figure>
								</div>
							</a>
					...
					<div class="col-md-6 col-sm-6 gallery-grids-right gallery-9">
						<div class="gallery-grid">
							<a class="example-image-link" href="images/gallery-9-big.jpg" data-lightbox="example-set" data-title="">
								<div class="grid">
									<figure class="effect-apollo">
										<img src="<?php echo URL_ASSETS;?>images/gallery-9.jpg" alt="Wanderer"/>
											<figcaption></figcaption>
									</figure>
								</div>
							</a>
		...
		<div class="container">
			...
			<div class="team-grids">
				<div class="col-md-3 col-sm-3 team-grid">
					<div class="pic">
						<div class="stack twisted">	
							<img src="<?php echo URL_ASSETS;?>images/team-1.jpg" alt="Wanderer" class="img-responsive" />
						</div>
				...
				<div class="col-md-3 col-sm-3 team-grid">
					<div class="pic">
						<div class="stack twisted">	
							<img src="<?php echo URL_ASSETS;?>images/team-2.jpg" alt="Wanderer" class="img-responsive" />
						</div>
						<span class="pic-caption top-to-bottom">
				...
				<div class="col-md-3 col-sm-3 team-grid">
					<div class="pic">
						<div class="stack twisted">	
							<img src="<?php echo URL_ASSETS;?>images/team-3.jpg" alt="Wanderer" class="img-responsive" />
						</div>
						<span class="pic-caption top-to-bottom">
				...
				<div class="col-md-3 col-sm-3 team-grid">
					<div class="pic">
						<div class="stack twisted">	
							<img src="<?php echo URL_ASSETS;?>images/team-4.jpg" alt="Wanderer" class="img-responsive" />
						</div>
						<span class="pic-caption top-to-bottom">
							<h4>Dexter Morgan</h4>
							<!-- Social-Icons -->
	...
	<div class="footer">
		<div class="container">
			...
			<div class="copyright">
				<p>&copy; 2016 Wanderer. All Rights Reserved | Design by <a href="http://w3layouts.com/" target="_blank"> W3layouts </a></p>
			</div>
