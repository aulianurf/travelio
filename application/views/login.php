...
<body class="hold-transition login-page"  style="background-image: url(<?php echo URL_ASSETS;?>images/a2.jpg); background-size:cover;">
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <a href="<?php echo base_url();?>welcome/register" class="text-center">Belum punya akun?</a>
